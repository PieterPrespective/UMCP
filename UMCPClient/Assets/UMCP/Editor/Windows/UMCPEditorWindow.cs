...
{
    public class UMCPEditorWindow : EditorWindow
    {
        ...
        {
            GetWindow<UMCPEditorWindow>("UMCP Editor");
        }

        private void OnEnable()
        {
            // Check initial states
            isUnityBridgeRunning = UMCPBridge.IsRunning;
        ...
        private void OnGUI()
        {
            ...
            GUI.Label(new Rect(titleRect.x + 10, titleRect.y + 6, titleRect.width - 20, titleRect.height),
                "UMCP Editor", EditorStyles.boldLabel);
            EditorGUILayout.Space(10);
